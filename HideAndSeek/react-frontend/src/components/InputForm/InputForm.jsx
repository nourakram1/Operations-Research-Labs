...
import generateGameSchema from '/src/../../schema/generateGameSchema.json'
import generateGameResponseSchema from '/src/../../schema/generateGameResponseSchema.json'
...
function InputForm() {
    ...
    const simulate = async () => {
        ...
        for (let i = 0; i < SIM_CNT; i++) {
            const hiderCoordinates = Object.values((await axios.post(`${import.meta.env.VITE_SERVER}/play`, hiderRequest)).data)
            const seekerCoordinates = Object.values((await axios.post(`${import.meta.env.VITE_SERVER}/play`, seekerRequest)).data)
